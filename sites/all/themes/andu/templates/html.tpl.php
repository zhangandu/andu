...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php endif; ?>
    ...
    <!-- andu -->
    <link type="text/css" href="<?php print $base_path; ?>styles/style.css" rel="stylesheet">
    <link type="text/css" href="<?php print $base_path; ?>styles/home.css" rel="stylesheet">
    <link type="text/css" href="<?php print $base_path; ?>styles/jquery.lightbox-0.5.css" rel="stylesheet">
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js">
    </script>
    <script src="<?php print $base_path; ?>js/jquery.lightbox-0.5.js">
    </script>
